...
data = {
  ...
  "chapter_number": 23,
  "chapter": "Clocks",
  "book_page_range": "824–833",
  "objective_questions": 54,
  "key_explanation_from_book": {
    "clock_face": "The clock face is divided into 60 equal minute spaces. The hour hand completes one revolution in 12 hours and the minute hand completes one revolution in 1 hour.",
    "angles": "Minute hand moves 6° per minute. Hour hand moves 30° per hour, or 1/2° per minute.",
    "angle_formula": "At H hours and M minutes, the angle between the hands is |30H - 11M/2| degrees; the smaller angle is taken when required.",
    "coincidence": "The hands coincide 11 times in every 12 hours, hence 22 times in a day.",
    "right_angle": "The hands are at right angles 22 times in every 12 hours, hence 44 times in a day.",
    "opposite": "The hands are in a straight line but opposite in direction 11 times in every 12 hours.",
    "gain_loss": "For a clock gaining or losing time, compare its indicated rate with the correct rate to determine the actual time.",
    "interval": "The minute hand gains on the hour hand at 55 minute-spaces per hour, which is used to calculate coincidence and separation times."
  },
  "exercise": {
    ...
    "questions": [
      ...
      },
      {
        ...
        "chapter": "Clocks",
        "question_number": 14,
        "question": "Match List I with List II and select the correct answer using the codes given below the lists. List I: A. 1.10 p.m., B. 2.15 p.m., C. 8.40 p.m. List II: 1. 20°, 2. 22 1/2°, 3. 24°, 4. 25°, 5. 30°",
        "options": {
          "a": "4, 2, 1",
          "b": "4, 3, 2",
          "c": "5, 2, 1",
      ...
      },
      {
        ...
        "options": {
          "a": "15 5/11 min past 3",
          "b": "16 4/11 min past 3",
          "c": "16 5/11 min past 3",
      ...
      },
      {
        ...
        "options": {
          "a": "3 hr 59 7/12 min p.m.",
          "b": "4 p.m.",
          "c": "3 hr 58 7/11 min p.m.",
          "d": "4 hr 2 3/11 min p.m."
        },
        "correct_option": "b",
        "answer": "4 p.m."
      },
  ...
  "verification": {
    ...
    "special_handling": [
      "Question 14 is a List I/List II matching question and is represented using separate list_i and list_ii fields.",
      "Questions 15–54 were extracted across the chapter's multi-page objective section.",
      "Fractions and superscript/layout artifacts from the PDF text layer were normalized."
    ]
  }
}

out_path = "/home/jyoti/Project/PLACEMENT/server/data/rs_agrawal/clocks.json"
os.makedirs(os.path.dirname(out_path), exist_ok=True)
with open(out_path, "w", encoding="utf-8") as f:
    json.dump(data, f, indent=2, ensure_ascii=False)

print(f"Successfully generated Clocks chapter JSON with {len(data['exercise']['questions'])} questions!")
