...
const filePath = path.join(__dirname, '../server/data/rs_agrawal/logarithms.json');
...
if (data.questions.length !== 92) {
  console.error(`ERROR: Expected 92 questions, found ${data.questions.length}`);
  errors++;
}
