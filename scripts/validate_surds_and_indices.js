...
const filePath = path.join(__dirname, '../server/data/rs_agrawal/surds_and_indices.json');
...
if (data.questions.length !== 109) {
  console.error(`ERROR: Expected 109 questions, found ${data.questions.length}`);
  errors++;
}
