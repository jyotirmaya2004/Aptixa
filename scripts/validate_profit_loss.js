...
const filePath = path.join(__dirname, '../server/data/rs_agrawal/profit_and_loss.json');
...
if (data.questions.length !== 319) {
  console.error(`ERROR: Expected 319 questions, found ${data.questions.length}`);
  errors++;
}
