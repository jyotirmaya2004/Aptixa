...
const file = path.join(__dirname, '../server/data/rs_agrawal/average.json');
...
if (errors === 0) {
  console.log(`\n0 errors. PASSED: 100% data integrity verified for Chapter 6 Average! (${data.questions.length} questions)`);
} else {
